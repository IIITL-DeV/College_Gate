...
import 'package:college_gate/panel/warden/w_exitrequest.dart';
import 'package:college_gate/panel/warden/w_student_home_register.dart';
import 'package:college_gate/panel/warden/wardenlog.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => w_studentRegister()));
                },
                child: Card(
                  elevation: 4,
